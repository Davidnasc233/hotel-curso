...
const quartos = {
    casal01: {
      ...
      description: "Este quarto possui uma cama de casal, ar-condicionado, Wi-Fi gratuito e uma vista incrível.",
      price: "R$ 299,00 por noite",
    },
    solteiro01: {
      title: "Detalhes do Quarto Solteiro 01",
      description: "Este quarto possui uma cama de solteiro, ar-condicionado, Wi-Fi gratuito e uma vista incrível.",
      price: "R$ 199,00 por noite",
    },
    casalSuite: {
      title: "Detalhes da Suíte Casal",
      description: "Esta suíte possui uma cama de casal, ar-condicionado, Wi-Fi gratuito, banheira e uma vista incrível.",
      price: "R$ 299,00 por noite",
    },
  };
  ...
  function abrirModalDetalhes(quartoId) {
    ...
    if (quarto && modalRoom) {
      ...
      document.getElementById("modalDescription").textContent = quarto.description;
      document.getElementById("modalPrice").innerHTML = `Preço: <strong>${quarto.price}</strong>`;
